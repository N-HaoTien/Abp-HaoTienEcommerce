using HaoTienEcommerce.IdentitySettings;
using HaoTienEcommerce.Inventories;
using HaoTienEcommerce.InventoryTickets;
using HaoTienEcommerce.Manufacturers;
using HaoTienEcommerce.Orders;
using HaoTienEcommerce.ProductAttributes;
using HaoTienEcommerce.ProductCategories;
using HaoTienEcommerce.Products;
using HaoTienEcommerce.Promotions;
...
public class HaoTienEcommerceDbContext :
    AbpDbContext<HaoTienEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public HaoTienEcommerceDbContext(DbContextOptions<HaoTienEcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HaoTienEcommerceConsts.DbTablePrefix + "YourEntities", HaoTienEcommerceConsts.DbSchema);
